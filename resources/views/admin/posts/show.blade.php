...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li><a href="{{ url('/admin/videos') }}">{{ __('categories.category') }}</a></li>
...
@section('main-content')
    <div class="box">
        <div class="box-header">
            ...
            <div class="box-tools">
                <a href="{{ url('/admin/videos') }}" class="btn btn-warning btn-sm"><i class="fa fa-arrow-left"
                        aria-hidden="true"></i> <span class="hidden-xs">{{ trans('message.lists') }}</span></a>
                @can('VideoController@update')
                    <a href="{{ url('/admin/videos/' . $video->id . '/edit') }}" class="btn btn-primary btn-sm"><i
            ...
            <table class="table table-striped">
                <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                        <th> {{ trans('theme::categories.active') }} </th>
                        <td> {{ $video->approved == 1 ? 'Duyệt' : "Chưa duyệt" }} </td>
                    </tr>
