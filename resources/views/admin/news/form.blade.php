    ...
    <table class="table  table-condensed">
        <tr class="row {{ $errors->has('title') ? 'has-error' : '' }}">
            <td class="col-md-4 col-lg-3">
                {!! Form::label('title', trans('news.title'), ['class' => 'control-label label-required']) !!}
            </td>
        ...
        <tr class="row {{ $errors->has('category_id') ? 'has-error' : '' }}">
            <td class="col-md-4 col-lg-3">
                {!! Form::label('category_id', trans('news.category'), ['class' => 'control-label label-required']) !!}
            </td>
            <td class="col-md-8 col-lg-9">
            ...
            <td class="col-md-8 col-lg-9">
                <div>
                    ...
                    <div class="imgprev-wrap" style="display:{{ !empty($news->image) ? 'block' : 'none' }}">
                        ...
                        <img class="img-preview" src="{{ !empty($news->image) ? asset($news->image) : '' }}" alt="{{ trans('news.image') }}" />
        ...
        <tr class="row {{ $errors->has('content_vi') ? 'has-error' : '' }}">
            <td class="col-md-4 col-lg-3">
                {!! Form::label('content', trans('news.content'), ['class' => 'control-label label-required']) !!}
            </td>
        ...
        <tr class="row {{ $errors->has('is_focus') ? 'has-error' : '' }}">
            <td class="col-md-4 col-lg-3">
                {!! Form::label('is_focus', trans('news.focus'), ['class' => 'control-label']) !!}
            </td>
            <td class="col-md-8 col-lg-9">
...
<div class="box-footer">
    {!! Form::button('<i class="fa fa-check-circle"></i> ' . ($text = isset($submitButtonText) ? $submitButtonText : __('message.save')), [
